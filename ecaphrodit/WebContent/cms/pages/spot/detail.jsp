...
<div id="createUserContent" class="cmscontent">
		...
		<s:form name="UpdateSpotRegisteredAction" action="UpdateSpotRegisteredAction" method="post">  
			...
			<s:select key="content.spot.choose" required="true" list="contentSpots" value="%{contentSpot.id}" 
			listKey="id" listValue="contentName" name="contentSpot.id"  headerKey="" headerValue="No content" />
